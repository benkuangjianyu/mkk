...
import com.cloud.mkk.admin.api.util.TreeUtil;
import com.cloud.mkk.admin.api.vo.MenuVO;
import com.cloud.mkk.admin.service.SysMenuService;
import com.cloud.mkk.admin.mapper.SysMenuMapper;
import com.cloud.mkk.admin.mapper.SysRoleMenuMapper;
import com.cloud.mkk.common.core.constant.CacheConstants;
import com.cloud.mkk.common.core.constant.CommonConstants;
import com.cloud.mkk.common.core.constant.enums.MenuTypeEnum;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
	...
	public ResponseRet removeMenuById(Integer id) {
		// 查询父节点为当前节点的节点
		List<SysMenu> menuList = this.list(Wrappers.<SysMenu>query().lambda().eq(SysMenu::getParentId, id));

		if (CollUtil.isNotEmpty(menuList)) {
			return ResponseRet.failed("菜单含有下级不能删除");
		}

		sysRoleMenuMapper.delete(Wrappers.<SysRoleMenu>query().lambda().eq(SysRoleMenu::getMenuId, id));
		// 删除当前菜单及其子菜单
		return ResponseRet.ok(this.removeById(id));
	}
