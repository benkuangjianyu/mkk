package com.cloud.mkk.gateway.filter;

import cn.hutool.core.util.StrUtil;
import com.cloud.mkk.gateway.config.GatewayConfigProperties;
...
import com.cloud.mkk.common.core.exception.ValidateCodeException;
...
/**
 * ValidateCodeGatewayFilter 验证码处理
 *
 * @author kuangjianyu
 * @date 2020-12-14
 */
		...
		return (exchange, chain) -> {
			...
			try {
				...
				return response.writeWith(Mono.create(monoSink -> {
					try {
						byte[] bytes = objectMapper.writeValueAsBytes(ResponseRet.failed(errMsg));
