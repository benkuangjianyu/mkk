 ...
 * @date 2020-12-14
 */
public class MicroUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			String fullname = (String) map.get(SecurityConstants.DETAILS_FULLNAME);
			...
			MicroUser user = new MicroUser(id, deptId, username, fullname, N_A, true, true, true, true, authorities);
