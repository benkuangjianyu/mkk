...
public class MicroUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) {
		...
		ResponseRet<UserInfo> result = remoteUserService.info(username, SecurityConstants.FROM_IN);
	 ...
	 * @return
	 */
	private UserDetails getUserDetails(ResponseRet<UserInfo> result) {
		...
		MicroUser tuser = new MicroUser(user.getUserId(), user.getDeptId(), user.getUsername(), user.getFullname(),
